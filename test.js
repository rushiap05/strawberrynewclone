...
<body>
  <div id="body">
    <div id="image">
        <div>
            <p> Gift & Specials > <span id="new">New Arrivals</span></p>
            <h1>NEW ARRIVALS</h1>
            </div>
            <div>
   ...
   <div id="box">
    <div id="combine">
        ...
        <div id="refine">
            ...
            <div id="brands">
                   <div>
                    <input type="checkbox" ><label for="">3w clinic</label>
                   </div>
                   <div>
                    <input type="checkbox" ><label for="">3w clinic</label>
                   </div>
    ...
    <div>
        <div id="image"><h3>New Arrivals</h3>
...
<script src="./js elements/new.js"></script>
